...
export type { Message, ReadyData, MessageDelete, MessageDeleteBulk, User, Member, Channel, Guild, Attachment, Embed, Reaction, Emoji } from './types';
...
export interface DiscordClientOptions {
  /**
   * Gateway intents to request. Defaults to GUILDS, GUILD_MESSAGES, DIRECT_MESSAGES, and MESSAGE_CONTENT.
   */
  intents?: number;
}
...
export class DiscordClient {
   ...
   */
  constructor(token: string, options: DiscordClientOptions = {}) {
   ...
   */
  on_ready(handler: ReadyHandler): void {
   ...
   */
  on_message_update(handler: MessageUpdateHandler): void {
   ...
   */
  on_message_delete(handler: MessageDeleteHandler): void {
   ...
   */
  on_message_delete_bulk(handler: MessageDeleteBulkHandler): void {
   ...
   */
  on_disconnect(handler: DisconnectHandler): void {
   ...
   */
  get_sequence_number(): number | null {
